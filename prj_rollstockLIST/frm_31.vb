...
Public Class frm_31
    Private Sub frm_31_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.WindowState = FormWindowState.Maximized
        fillGrid("select * from tab_31")
    End Sub
    ...
    Private Sub btnInsert_Click(sender As Object, e As EventArgs) Handles btnInsert.Click
        ...
        Dim cmd As New SqlCommand("insert into tab_31 (BF,GSM,WEIGHT) values(@B,@G,@W)", cnn)
        With cmd.Parameters
            .AddWithValue("@B", BF)
            .AddWithValue("@G", GSM)
    ...
    Private Sub DataGridView1_Click(sender As Object, e As EventArgs) Handles DataGridView1.Click
        ...
        Dim ada As New SqlDataAdapter("select * from tab_31 where id=" & id.ToString, cnn)
    ...
    Private Sub btnCompleteRoll_Click(sender As Object, e As EventArgs) Handles btnCompleteRoll.Click
        ...
        cmd.CommandText = "delete from tab_31 where id=@i"
        cmd.Connection = cnn
        Try
            With cmd.Parameters
            ...
            fillGrid("select * from tab_31 where WEIGHT like '%" & txtSearch.Text & "%'")
