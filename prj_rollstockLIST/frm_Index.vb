...
Public Class frm_Index
    Private Sub frm_Index_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Me.WindowState = FormWindowState.Maximized
        fillGrid("select * from data")
    ...
    Private Sub btnInsert_Click(sender As Object, e As EventArgs) Handles btnInsert.Click
        ...
        Dim cmd As New SqlCommand("insert into data (BF,GSM,WEIGHT) values(@B,@G,@W)", cnn)
        With cmd.Parameters
            .AddWithValue("@B", BF)
            .AddWithValue("@G", GSM)
    ...
    Private Sub DataGridView1_Click(sender As Object, e As EventArgs) Handles DataGridView1.Click
        ...
        Dim ada As New SqlDataAdapter("select * from data where id=" & id.ToString, cnn)
    ...
    Private Sub btnCompleteRoll_Click(sender As Object, e As EventArgs) Handles btnCompleteRoll.Click
        ...
        Try
            ...
            fillGrid("select * from data where WEIGHT like '%" & txtSearch.Text & "%'")
